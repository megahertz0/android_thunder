...
public final class i {
    ...
    public static int a(char c) {
        int i = AccessibilityNodeInfoCompat.ACTION_NEXT_AT_MOVEMENT_GRANULARITY;
        if (c >= 'A' && c <= 'Z') {
            i = c - 65;
        }
        if (c >= 'a' && c <= 'z') {
    ...
    public static String a(b bVar, List<NeighboringCellInfo> list) {
        ...
        int i = bVar.b;
        int i2 = bVar.c;
        if (a(bVar.a, i, i2, bVar.d, bVar.e)) {
            stringBuilder.append(a(i, i2, bVar.d, bVar.e, bVar.f, bVar.g, bVar.h));
            obj = 1;
        }
        if (list != null) {
            try {
                ...
                for (NeighboringCellInfo neighboringCellInfo : list) {
                    ...
                    if (a(bVar.a, i, i2, parseInt, neighboringCellInfo.getCid())) {
                        if (r8 > 0) {
                            stringBuilder.append(MiPushClient.ACCEPT_TIME_SEPARATOR);
                        }
                        stringBuilder.append(a(i, i2, parseInt, neighboringCellInfo.getCid(), (neighboringCellInfo.getRssi() << 1) - 113, InMobiClientPositioning.NO_REPEAT, InMobiClientPositioning.NO_REPEAT));
                        parseInt = r8 + 1;
                    } else {
                        parseInt = r8;
                    }
    ...
    public static String a(e.b bVar) {
        ...
        stringBuilder.append(new StringBuilder(h.f).append(b.getAltitude()).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(b.getAccuracy()).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(b.getBearing()).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(b.getSpeed()).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(b.getTime()).append(h.f).toString());
        stringBuilder.append(h.d);
        return stringBuilder.toString();
    }
    ...
    public static boolean c(String str) {
        try {
            ...
            if (str.contains(ParamKey.LATITUDE)) {
                int i = 1;
            } else {
                z = false;
            }
