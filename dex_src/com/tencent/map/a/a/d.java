...
public class d {
    ...
    public String toString() {
        ...
        if (this.z == 4 && this.w != null) {
            ...
            while (it.hasNext()) {
                c cVar = (c) it.next();
                stringBuilder.append(cVar.a).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(cVar.b).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(cVar.c).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(cVar.d).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(cVar.e).append(MiPushClient.ACCEPT_TIME_SEPARATOR).append(cVar.f).append("\n");
            }
        }
        if (this.z == 7) {
            if (this.h == 0) {
