    ...
    public final void run() {
        try {
            ...
            if (StatConfig.isDebugEnable()) {
                StatServiceImpl.q.i(new StringBuilder("add begin key:").append(this.b).toString());
            }
            if (StatServiceImpl.e.containsKey(this.b)) {
                StatServiceImpl.q.warn(new StringBuilder("Duplicate CustomEvent key: ").append(this.b.toString()).append(", trackCustomBeginKVEvent() repeated?").toString());
