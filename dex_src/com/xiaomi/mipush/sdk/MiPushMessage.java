...
public class MiPushMessage implements a {
    ...
    public String toString() {
        return new StringBuilder("messageId={").append(this.messageId).append("},passThrough={").append(this.passThrough).append("},alias={").append(this.alias).append("},topic={").append(this.topic).append("},userAccount={").append(this.userAccount).append("},content={").append(this.content).append("},description={").append(this.description).append("},title={").append(this.title).append("},isNotified={").append(this.isNotified).append("},notifyId={").append(this.notifyId).append("},notifyType={").append(this.notifyType).append("}, category={").append(this.category).append("}, extra={").append(this.extra).append(h.d).toString();
    }
}
