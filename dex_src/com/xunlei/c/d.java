    ...
    private static class b {
        ...
        public static String a(String str, String str2) throws UnsupportedEncodingException {
            ...
            while (matcher.find(i) && i < str.length()) {
                ...
                byte[] bytes = str.substring(start, i).replaceAll("%", BuildConfig.VERSION_NAME).getBytes();
                try {
                    stringBuilder.append(Charset.forName(str2).newDecoder().decode(ByteBuffer.wrap(com.xunlei.c.a.a.a(bytes, bytes.length))).toString());
                    i2 = i;
