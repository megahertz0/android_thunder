...
public final class af extends a {
    ...
    private af(View view, i iVar, com.xunlei.downloadprovider.download.tasklist.list.a aVar) {
        super(view);
        this.l = aVar;
        this.k = iVar;
    }

    public static af a(Context context, ViewGroup viewGroup, i iVar, com.xunlei.downloadprovider.download.tasklist.list.a aVar) {
        return new af(a.a(context, viewGroup), iVar, aVar);
    }
            ...
            if (bVar.q == 0) {
                ...
                if (nativeADDataRef.isAPP()) {
                    ...
                    if (!h.a(nativeADDataRef.getDownloadCount()).equals("0")) {
                        ...
                        this.a.setOnClickListener(new ak(this, nativeADDataRef));
                        if (r.c().e != null || r.c().e.d()) {
                ...
                this.a.setOnClickListener(new ao(this, nativeResponse));
                if (r.c().e == null || r.c().e.d()) {
                    this.f.setVisibility(0);
                } else {
                    this.f.setVisibility(SpdyProtocol.PUBKEY_SEQ_ADASH);
                ...
                if (!(TextUtils.isEmpty(bVar.l) || bVar.l.equals("0") || !bVar.k.equals(c.c))) {
                    ...
                    if (a3 == null || !a3.trim().equals("0")) {
                        ...
                        this.a.setOnClickListener(new ag(this, bVar));
                        if (r.c().e != null || r.c().e.d()) {
                            this.f.setVisibility(0);
                        } else {
                            this.f.setVisibility(SpdyProtocol.PUBKEY_SEQ_ADASH);
                        }
                        this.f.setOnClickListener(new aj(this, bVar));
        ...
        if (!str.equals("0")) {
            if (str.equals(c.f)) {
                if (!TextUtils.isEmpty(bVar.g)) {
                    ...
                    BrowserUtil.a();
                    BrowserUtil.a(afVar.c(), bVar.g, bVar.h, 0, bundle);
                }
            } else if (str.equals(c.e)) {
                if (!TextUtils.isEmpty(bVar.g)) {
                    BrowserUtil.a();
                    BrowserUtil.a(afVar.c(), 0, bVar.g, true, null, false, null);
                }
                ...
                if (!TextUtils.isEmpty(str2)) {
                    ...
                    bVar2.e = bVar.n;
                    bVar2.d = true;
                    ((ThunderTask) afVar.c()).createLocalTaskWithAdditionInfo(str2, bVar.n, 0, null, null, null, 0, gVar, null, false, bVar2);
                }
            }
        }
    }
