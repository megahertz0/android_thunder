...
public class ChoicenessShortVideoItemView3 extends FrameLayout implements d<com.xunlei.downloadprovider.homepage.choiceness.a.a.a> {
    ...
    private void a(Context context) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.choiceness_short_video_item_3, this, true);
        a aVar = new a();
