    ...
    public final void a(Message message) {
        ...
        switch (message.what) {
            ...
            case 1014:
                ...
                str2 = message.getData().getString("url_key");
                BrowserUtil.a();
            ...
            case 1015:
                ...
                str = message.getData().getString("url_key");
            ...
            case 1046:
                ...
                DownloadCenterActivity.a(this.a, BuildConfig.VERSION_NAME);
            case 1047:
                str = RemoteDownloadActivity.a;
            ...
            case 1378:
                if (message.obj instanceof String) {
                    ...
                    if (!TextUtils.isEmpty(str)) {
                        try {
                            this.a.f = new JSONObject(str).getString("callback");
                ...
                this.a.startActivityForResult(intent2, SimpleLog.LOG_LEVEL_ERROR);
            case 1381:
            ...
            case 1382:
                if (message.obj instanceof String) {
                    ...
                    if (!TextUtils.isEmpty(str)) {
                        try {
                            this.a.g = new JSONObject(str).getString("callback");
