...
class XZBDevice$8 extends AsynTask {
    final /* synthetic */ XZBDevice this$0;
    final /* synthetic */ List val$taskInfoList;
    final /* synthetic */ Object val$userData;

    XZBDevice$8(XZBDevice xZBDevice, Object obj, String str, Object obj2, List list, Object obj3) {
    ...
    public void run() {
        ...
        XZBPauseTask xZBPauseTask = new XZBPauseTask(this.this$0.getPid());
        ...
        HttpResponse httpGet = xZBPauseTask.httpGet();
        ...
        XZBLog.d(XZBDevice.access$300(), new StringBuilder("pauseTask response = ").append(stringBody).toString());
