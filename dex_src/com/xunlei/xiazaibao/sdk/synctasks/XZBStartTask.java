...
public class XZBStartTask extends XZBRemoteDownloadBaseTask {
    private static final String TAG;
    private String mPid;
    private ArrayList<String> mTaskIds;

    static {
        TAG = XZBStartTask.class.getSimpleName();
    }

    public XZBStartTask(String str) {
        this.mPid = str;
    ...
    public String getUrl() {
        ...
        stringBuffer.append(getBaseUrl() + "/start");
