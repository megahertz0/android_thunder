...
public final class a {
    ...
    public static void a(Context context, String str) {
        if (context == null) {
            ...
            try {
                ...
                XLLog.a("Relinker", new StringBuilder("loadLibrary, UnsatisfiedLinkError1=").append(e4.getMessage()).toString());
                try {
                    File b = b(context, str);
                    XLLog.a("Relinker", new StringBuilder("loadLibrary, workaroundFile=").append(b.getPath()).toString());
                    if (!b.exists()) {
                        c(context, str);
                    }
                    System.load(b.getAbsolutePath());
                } catch (Exception e5) {
                    XLLog.a("Relinker", new StringBuilder("Exception=").append(e5.getMessage()).toString());
    ...
    private static void c(android.content.Context r13, java.lang.String r14) {
        throw new UnsupportedOperationException("Method not decompiled: com.xunlei.android.xlstat.a.c(android.content.Context, java.lang.String):void");
        /* JADX: method processing error */
/*
        Error: jadx.core.utils.exceptions.JadxRuntimeException: Try/catch wrap count limit reached in com.xunlei.android.xlstat.a.c(android.content.Context, java.lang.String):void
...
*/
        ...
        r0 = "Relinker";
        r1 = "unpackLibrary";
        com.xunlei.android.xlstat.XLLog.a(r0, r1);
    ...
    L_0x0024:
        ...
        com.xunlei.android.xlstat.XLLog.a(r0, r1);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
    ...
    L_0x0058:
        r0 = a();	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
    ...
    L_0x0073:
        ...
        com.xunlei.android.xlstat.XLLog.a(r9, r10);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
    ...
    L_0x00b5:
        ...
        com.xunlei.android.xlstat.XLLog.a(r1, r2);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
        if (r0 == 0) goto L_0x00ef;
    L_0x00c0:
        r1 = new com.xunlei.android.xlstat.a$a;	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
    ...
    L_0x00c8:
        ...
        com.xunlei.android.xlstat.XLLog.a(r1, r0);	 Catch:{ all -> 0x01c0 }
    ...
    L_0x00e9:
        ...
        goto L_0x0041;
    L_0x00ef:
        r0 = new com.xunlei.android.xlstat.a$a;	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
    ...
    L_0x00fb:
        throw r0;
    L_0x00fc:
        r0 = b(r13, r14);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
    ...
    L_0x0109:
        ...
        com.xunlei.android.xlstat.XLLog.a(r0, r1);	 Catch:{ IOException -> 0x0115 }
        r0 = r6;
        goto L_0x004e;
    L_0x0115:
        r0 = move-exception;
        ...
        r0 = r0.toString();	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
        com.xunlei.android.xlstat.XLLog.a(r1, r0);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
        r0 = r6;
        goto L_0x004e;
    L_0x0133:
        ...
        a(r3, r1);	 Catch:{ FileNotFoundException -> 0x01d4, IOException -> 0x01cf }
        a(r3);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
        a(r1);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
        r1 = 1;
        r2 = 0;
    ...
    L_0x0163:
        ...
        com.xunlei.android.xlstat.XLLog.a(r7, r0);	 Catch:{ all -> 0x01ca }
        a(r3);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
        a(r1);	 Catch:{ Exception -> 0x00c6, all -> 0x00f5 }
        r0 = r6;
        goto L_0x004e;
    ...
    private static String[] a() {
        ...
        try {
            ...
            XLLog.a("Relinker", new StringBuilder(" getSupportedABIs IllegalAccessException, ").append(e.getMessage()).toString());
            e.printStackTrace();
            return strArr;
        } catch (IllegalArgumentException e2) {
            XLLog.a("Relinker", new StringBuilder(" getSupportedABIs IllegalArgumentException, ").append(e2.getMessage()).toString());
            e2.printStackTrace();
            return strArr;
        } catch (NoSuchFieldException e3) {
            XLLog.a("Relinker", new StringBuilder(" getSupportedABIs NoSuchFieldException, ").append(e3.getMessage()).toString());
            e3.printStackTrace();
            return strArr;
        }
    }
