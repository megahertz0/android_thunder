...
class ed implements OnClickListener {
    ...
    ed(ea eaVar, AdapterView adapterView, int i) {
        this.c = eaVar;
        this.a = adapterView;
        this.b = i;
    }
