            ...
            case MqttConnectOptions.MQTT_VERSION_DEFAULT:
                ...
                f.a().e().get(f.a().d(), c, null, new BaseHttpClientListener() {
                    public final void onSuccess(int i, Header[] headerArr, byte[] bArr) {
                        ...
                        try {
                            int optInt = new JSONObject(XLUtilTools.parseJSONPString(str)).optInt("ret", R.styleable.AppCompatTheme_checkedTextViewStyle);
                            if (optInt == 99) {
                            ...
                            a.this.h = 1;
                            a.a(a.this, R.styleable.AppCompatTheme_checkedTextViewStyle);
                        }
                    }
