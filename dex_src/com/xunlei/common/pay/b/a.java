...
public final class a extends b {
    ...
    public final String a() {
        ...
        if (this.f.mOrderType == 0) {
            stringBuffer.append("http://dypay.vip.xunlei.com/phonepay/order/?userid=").append(this.f.mUserId).append("&sessionid=").append(this.f.mSessionId).append("&access_token=").append(this.f.mAccessToken).append("&payway=").append(super.e()).append("&vastype=").append(this.f.mVasType).append("&month=").append(this.f.mMonth).append("&source=").append(this.f.mSource).append("&referfrom=").append(this.f.mReferFrom).append("&other1=").append(super.f()).append("&other2=").append(super.g()).append("&other4=").append(super.h()).append("&ext1=").append(super.i()).append("&ext2=").append(super.j()).append("&bgurl=").append(super.k()).append("&callback=").append(System.currentTimeMillis());
        } else if (this.f.mOrderType == 1) {
            stringBuffer.append("http://dypay.vip.xunlei.com/phonepay/upgrade/?userid=").append(this.f.mUserId).append("&sessionid=").append(this.f.mSessionId).append("&access_token=").append(this.f.mAccessToken).append("&payway=").append(super.e()).append("&vastype=").append(this.f.mVasType).append("&tdays=").append(this.f.mMonth).append("&source=").append(this.f.mSource).append("&referfrom=").append(this.f.mReferFrom).append("&other1=").append(super.f()).append("&other2=").append(super.g()).append("&other4=").append(super.h()).append("&ext1=").append(super.i()).append("&ext2=").append(super.j()).append("&callback=").append(System.currentTimeMillis());
        }
    ...
    public final String b() {
        StringBuffer stringBuffer = new StringBuffer();
        stringBuffer.append("http://dypay.vip.xunlei.com/phonepay/getprice/?userid=").append(this.f.mUserId).append("&access_token=").append(this.f.mAccessToken).append("&type=").append(this.f.mOrderType).append("&vastype=").append(this.f.mVasType).append("&payway=").append(super.e()).append("&source=").append(this.f.mSource).append("&callback=").append(System.currentTimeMillis());
        return stringBuffer.toString();
    }

    public final String c() {
        StringBuffer stringBuffer = new StringBuffer();
        stringBuffer.append("http://dypay.vip.xunlei.com/channelpay/monthUnsign/?userid=").append(this.f.mUserId).append("&sessionid=").append(this.f.mSessionId).append("&vastype=").append(this.f.mVasType).append("&source=").append(this.f.mSource).append("&payway=").append(super.e()).append("&callback=").append(System.currentTimeMillis());
        return stringBuffer.toString();
    }

    public final String d() {
        StringBuffer stringBuffer = new StringBuffer();
        stringBuffer.append("http://dypay.vip.xunlei.com/channelpay/monthQuerysign/?userid=").append(this.f.mUserId).append("&sessionid=").append(this.f.mSessionId).append("&vastype=").append(this.f.mVasType).append("&source=").append(this.f.mSource).append("&payway=").append(super.e()).append("&callback=").append(System.currentTimeMillis());
        return stringBuffer.toString();
    }
