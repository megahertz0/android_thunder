...
public final class a {
    ...
    public class a extends AlertDialog {
        ...
        protected final void onCreate(Bundle bundle) {
            ...
            layoutParams.setMargins(a(a.this.f, 17.0f), a(a.this.f, (float) TitleBar.SHAREBTN_RIGHT_MARGIN), a(a.this.f, 8.0f), a(a.this.f, (float) TitleBar.SHAREBTN_RIGHT_MARGIN));
            imageView.setLayoutParams(layoutParams);
            imageView.setScaleType(ScaleType.FIT_CENTER);
            imageView.setImageDrawable(a(context, d));
            ...
            textView.setText(TextUtils.isEmpty(a.this.g) ? a : a.this.g);
        ...
        private static Drawable a(Context context, String str) {
            ...
            try {
                InputStream byteArrayInputStream = new ByteArrayInputStream(com.alipay.sdk.encrypt.a.a(str));
                try {
