...
public class MobclickAgentJSInterface {
    ...
    final class a extends WebChromeClient {
        ...
        public a(WebChromeClient webChromeClient) {
            this.a = null;
            this.c = "ekv";
            this.d = NotificationCompatApi21.CATEGORY_EVENT;
        ...
        public final boolean onJsPrompt(WebView webView, String str, String str2, String str3, JsPromptResult jsPromptResult) {
            if ("ekv".equals(str2)) {
                try {
                    ...
                    String str4 = (String) jSONObject.remove(SocializeConstants.WEIBO_ID);
            ...
            } else if (!NotificationCompatApi21.CATEGORY_EVENT.equals(str2)) {
                ...
                try {
                    ...
                    MobclickAgent.getAgent().a(MobclickAgentJSInterface.this.a, jSONObject2.getString("tag"), optString, (long) jSONObject2.optInt("duration"), 1);
                } catch (Exception e2) {
                }
            }
