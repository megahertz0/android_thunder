...
public class MobclickAgent {
    ...
    public static void onResume(Context context, String str, String str2) {
        if (context == null) {
            ...
            v.c("unexpected empty appkey in onResume");
        } else {
    ...
    public static void onEventDuration(Context context, String str, long j) {
        if (j <= 0) {
            v.a("duration is not valid in onEventDuration");
        } else {
    ...
    public static void onSocialEvent(Context context, String str, UMPlatformData... uMPlatformDataArr) {
        if (context == null) {
            v.c("context is null in onShareEvent");
            return;
        }
        e.e = MessageService.MSG_DB_NOTIFY_DISMISS;
    ...
    public static void onProfileSignIn(String str, String str2) {
        if (TextUtils.isEmpty(str2)) {
            ...
            v.b("uid is Illegal(length bigger then  legitimate length).");
        } else if (TextUtils.isEmpty(str)) {
            b.b("_adhoc", str2);
        } else if (str.length() > 32) {
            v.b("provider is Illegal(length bigger then  legitimate length).");
        } else {
            b.b(str, str2);
        }
    }
