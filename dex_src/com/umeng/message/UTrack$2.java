...
class UTrack$2 implements Runnable {
    ...
    public void run() {
        ...
        if (TextUtils.isEmpty(this.a)) {
            ...
            str = str2 + "addExclusiveAlias: empty type";
        ...
        if (MessageSharedPrefs.getInstance(UTrack.a(this.d)).isAliasSet(1, this.b, this.a)) {
            UmLog.d(UTrack.a(), String.format("addExclusiveAlias: <%s, %s> has been synced to the server before. Ingore this request.", new Object[]{this.b, this.a}));
            str3 = str3 + String.format("addExclusiveAlias: <%s, %s> has been synced to the server before. Ingore this request.", new Object[]{this.b, this.a});
        ...
        try {
            ...
            if (uTrack$SuccessState == null) {
                ...
                b.put("last_alias", MessageSharedPrefs.getInstance(UTrack.a(this.d)).getLastAlias(1, this.a));
            ...
            UTrack.b().addExclusiveAlias(this.b, this.a, b, this.c, true);
        } catch (Exception e) {
            exception = e;
            b = null;
            if (exception.getMessage().contains(MsgConstant.HTTPS_ERROR)) {
                UTrack.b().addExclusiveAlias(this.b, this.a, b, this.c, false);
            } else {
                this.c.onMessage(false, new StringBuilder("alias:").append(this.b).append("\u6dfb\u52a0\u5931\u8d25:").append(exception.getMessage()).toString());
            }
            MessageSharedPrefs.getInstance(UTrack.a(this.d)).addAlias(this.b, this.a, 1, 1, exception.getMessage());
        }
    }
}
