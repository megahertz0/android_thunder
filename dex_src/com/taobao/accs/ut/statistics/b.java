                ...
                try {
                    ...
                    try {
                        ...
                        if (ALog.isPrintLog(Level.D)) {
                            ALog.d("accs.BindUserStatistic", UTMini.getCommitInfo((int) UT.EVENT_ID, (String) obj, null, (String) obj2, hashMap), new Object[0]);
                        }
                        UTMini.getInstance().commitEvent((int) UT.EVENT_ID, str, obj, null, obj2, hashMap);
                    } catch (Throwable th2) {
                        th = th2;
                        ALog.d("accs.BindUserStatistic", UTMini.getCommitInfo((int) UT.EVENT_ID, str2, null, str3, hashMap) + " " + th.toString(), new Object[0]);
                    }
                } catch (Throwable th3) {
                    th = th3;
                    str3 = null;
