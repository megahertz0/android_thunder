...
class TransportMediatorJellybeanMR2 {
    ...
    void takeAudioFocus() {
        if (!this.mAudioFocused) {
            ...
            this.mAudioManager.requestAudioFocus(this.mAudioFocusChangeListener, XZBDevice.DOWNLOAD_LIST_FAILED, 1);
        }
    }
    ...
    public void startPlaying() {
        if (this.mPlayState != 3) {
            this.mPlayState = 3;
            this.mRemoteControl.setPlaybackState(XZBDevice.DOWNLOAD_LIST_FAILED);
        }
        if (this.mFocused) {
            takeAudioFocus();
        }
    ...
    public void refreshState(boolean z, long j, int i) {
        if (this.mRemoteControl != null) {
            this.mRemoteControl.setPlaybackState(z ? 3 : 1, j, z ? 1.0f : AutoScrollHelper.RELATIVE_UNSPECIFIED);
    ...
    public void pausePlaying() {
        if (this.mPlayState == 3) {
            this.mPlayState = 2;
            this.mRemoteControl.setPlaybackState(XZBDevice.DOWNLOAD_LIST_RECYCLE);
        }
        dropAudioFocus();
    }
