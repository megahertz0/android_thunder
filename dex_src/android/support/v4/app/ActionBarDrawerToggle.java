...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    private class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.translate(((float) i) * (((-this.mOffset) * ((float) width)) * this.mPosition), AutoScrollHelper.RELATIVE_UNSPECIFIED);
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean z, int i, int i2, int i3) {
        ...
        this.mSlider.setOffset(z ? TOGGLE_DRAWABLE_OFFSET : AutoScrollHelper.RELATIVE_UNSPECIFIED);
    }
    ...
    public void onDrawerSlide(View view, float f) {
        ...
        if (f > 0.5f) {
            position = Math.max(position, Math.max(AutoScrollHelper.RELATIVE_UNSPECIFIED, f - 0.5f) * 2.0f);
        } else {
