...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    class AnonymousClass_1 extends Animation {
        ...
        public void applyTransformation(float f, Transformation transformation) {
            ...
            if (f <= 0.5f) {
                ...
                this.val$ring.setStartTrim(startingStartTrim + (MATERIAL_INTERPOLATOR.getInterpolation(f / 0.5f) * f2));
            }
            if (f > 0.5f) {
                this.val$ring.setEndTrim(((0.8f - access$100) * MATERIAL_INTERPOLATOR.getInterpolation((f - 0.5f) / 0.5f)) + startingEndTrim);
            }
    ...
    class AnonymousClass_2 implements AnimationListener {
        ...
        public void onAnimationStart(Animation animation) {
            MaterialProgressDrawable.this.mRotationCount = AutoScrollHelper.RELATIVE_UNSPECIFIED;
        }
    ...
    public void updateSizes(@ProgressDrawableSize int i) {
        if (i == 0) {
            ...
            setSizeParameters(40.0d, 40.0d, 8.75d, 2.5d, TitleBar.SHAREBTN_RIGHT_MARGIN, NUM_POINTS);
        }
    }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation anonymousClass_1 = new AnonymousClass_1(ring);
        anonymousClass_1.setRepeatCount(-1);
        anonymousClass_1.setRepeatMode(DEFAULT);
        anonymousClass_1.setInterpolator(LINEAR_INTERPOLATOR);
        anonymousClass_1.setAnimationListener(new AnonymousClass_2(ring));
