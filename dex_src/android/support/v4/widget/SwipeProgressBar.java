...
final class SwipeProgressBar {
    ...
    final void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (this.mRunning) {
                ...
                this.mClipRect.set(((float) i) - f2, AutoScrollHelper.RELATIVE_UNSPECIFIED, f2 + ((float) i), (float) height);
    ...
    private void drawCircle(Canvas canvas, float f, float f2, int i, float f3) {
        ...
        canvas.drawCircle(AutoScrollHelper.RELATIVE_UNSPECIFIED, AutoScrollHelper.RELATIVE_UNSPECIFIED, f, this.mPaint);
        canvas.restore();
    }
