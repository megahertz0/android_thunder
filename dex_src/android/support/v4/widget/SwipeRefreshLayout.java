...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    private void reset() {
        ...
        this.mProgress.stop();
        this.mCircleView.setVisibility(XZBDevice.Wait);
    ...
    private Animation startAlphaAnimation(int i, int i2) {
        ...
        Animation anonymousClass_4 = new AnonymousClass_4(i, i2);
    ...
    public void setColorSchemeResources(int... iArr) {
        ...
        for (int i = LARGE; i < iArr.length; i++) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mTarget != null) {
            ...
            this.mCircleViewIndex = -1;
            for (i3 = LARGE; i3 < getChildCount(); i3++) {
    ...
    public boolean canChildScrollUp() {
        ...
        if (!(this.mTarget instanceof AbsListView)) {
            return ViewCompat.canScrollVertically(this.mTarget, INVALID_POINTER) || this.mTarget.getScrollY() > 0;
        } else {
    ...
    private void moveSpinner(float f) {
        ...
        abs = Math.max(AutoScrollHelper.RELATIVE_UNSPECIFIED, Math.min(abs, f2 * 2.0f) / f2);
        ...
        this.mProgress.setStartEndTrim(AutoScrollHelper.RELATIVE_UNSPECIFIED, Math.min(MAX_PROGRESS_ANGLE, max * 0.8f));
    ...
    private void animateOffsetToCorrectPosition(int i, AnimationListener animationListener) {
        ...
        this.mAnimateToCorrectPosition.setDuration(Constants.ST_UPLOAD_MAX_COUNT);
    ...
    private void animateOffsetToStartPosition(int i, AnimationListener animationListener) {
        ...
        this.mAnimateToStartPosition.setDuration(Constants.ST_UPLOAD_MAX_COUNT);
