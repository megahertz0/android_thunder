    ...
    private static class DonutFloatValueAnimator implements ValueAnimatorCompat {
            ...
            this.mLoopRunnable = new Runnable() {
                public void run() {
                    ...
                    if (DonutFloatValueAnimator.this.mFraction >= 1.0f) {
                        ...
                        DonutFloatValueAnimator.this.mTarget.postDelayed(DonutFloatValueAnimator.this.mLoopRunnable, PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS);
                    }
                }
            };
        }
        ...
        public void start() {
            if (!this.mStarted) {
                ...
                this.mTarget.postDelayed(this.mLoopRunnable, PlaybackStateCompat.ACTION_SKIP_TO_PREVIOUS);
            }
        }
