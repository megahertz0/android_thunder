            ...
            switch (action & 255) {
                ...
                case SHOW_PRESS:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        velocityTracker.computeCurrentVelocity(IHost.HOST_NOFITY_REFRESH_LIST, (float) this.mMaximumFlingVelocity);
                        ...
                        actionIndex = (Math.abs(yVelocity) > ((float) this.mMinimumFlingVelocity) || Math.abs(xVelocity) > ((float) this.mMinimumFlingVelocity)) ? this.mListener.onFling(this.mCurrentDownEvent, motionEvent, xVelocity, yVelocity) : 0;
                    }
                ...
                case R.styleable.Toolbar_contentInsetEnd:
                    ...
                    this.mLastFocusY = f;
                    this.mDownFocusY = f;
                    this.mVelocityTracker.computeCurrentVelocity(IHost.HOST_NOFITY_REFRESH_LIST, (float) this.mMaximumFlingVelocity);
