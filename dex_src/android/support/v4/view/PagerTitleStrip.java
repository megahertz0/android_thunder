...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    public PagerTitleStrip(Context context, AttributeSet attributeSet) {
        ...
        if (obtainStyledAttributes.hasValue(XZBDevice.DOWNLOAD_LIST_RECYCLE)) {
            dimensionPixelSize = obtainStyledAttributes.getColor(XZBDevice.DOWNLOAD_LIST_RECYCLE, 0);
        ...
        this.mGravity = obtainStyledAttributes.getInteger(XZBDevice.DOWNLOAD_LIST_FAILED, R.styleable.AppCompatTheme_panelMenuListTheme);
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        max -= i2;
        int measuredHeight = this.mNextText.getMeasuredHeight() + max;
        i2 = Math.max(Math.max(this.mPrevText.getMeasuredHeight() + baseline, this.mCurrText.getMeasuredHeight() + measuredWidth2), measuredHeight);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int childMeasureSpec2 = getChildMeasureSpec(i, (int) (((float) size) * 0.2f), Tabs.TAB_CREATE_REACH_MAX_COUNT);
